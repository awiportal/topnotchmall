	...
	private function pages(): array {
        ...
        return array(
            ...
            'payment-methods' => array(
                ...
                'content' => "<p>We keep paying simple and secure. Choose whichever option suits you when you check out or when you order by phone.</p><h2>M-PESA</h2><p>Pay by M-PESA using the till or paybill details shown at checkout, or send payment directly when you order by phone or WhatsApp. Keep the M-PESA confirmation message as your proof of payment.</p><h2>Visa and Mastercard</h2><p>We accept Visa and Mastercard debit and credit cards. Card payments are handled by our licensed processor over an encrypted connection, so we never see or store your full card number.</p><h2>Cash on delivery</h2><p>Cash on delivery is not available everywhere. It applies to selected locations and order values only, and our team confirms whether it applies to your order before we dispatch it. Everywhere else, orders are paid before dispatch.</p><h2>Prices and currency</h2><p>All prices are in Kenya Shillings (KSh) and are the same on the product page, in your cart and at checkout. Delivery is a flat KSh 500 to any destination in Kenya and is shown at checkout before you pay, so there are no surprises at the end. Bulk orders and heavy machinery are quoted separately and agreed with you first.</p><p>If you have a question about payment, call or WhatsApp {$phone}.</p>",
            ),
            'cookie-policy' => array(
                'title'   => 'Cookie Policy',
